          ...
          <tbody className="bg-slate-900 divide-y divide-slate-800">
            {isLoading ? (
              ...
              <tr key={user.userId} className="hover:bg-slate-800 transition-colors">
                ...
                <td className="px-6 py-4">
                  <span className={`px-2 py-1 text-xs rounded ${user.role === 'ADMIN' ? 'bg-purple-900/30 text-purple-400 border border-purple-900/50' : 'bg-slate-800 text-slate-300 border border-slate-700'
                    }`}>
                    {user.role}
                  </span>
                </td>
                <td className="px-6 py-4">
                  <div className="flex flex-col space-y-1">
                    <span className={`px-2 py-1 text-xs rounded w-fit ${user.status === 'ACTIVE' ? 'bg-green-900/30 text-green-400 border border-green-900/50' :
